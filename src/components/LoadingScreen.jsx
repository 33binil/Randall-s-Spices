...
const LoadingScreen = () => {
    ...
    return (
        <div className="flex items-center justify-center h-screen bg-[#f6f6f4] relative">
            ...
            {/* Countdown number */}
            <div className="absolute bottom-6 top-[620px] md:top-[800px] left-[150px] md:left-[1500px] text-5xl md:text-8xl lg:text-8xl font-bold text-gray-500 px-4 py-2 rounded-lg">
