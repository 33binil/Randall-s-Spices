    ...
    return (
        <div className="relative min-h-screen min-w-screen bg-[#111111] overflow-hidden">
            ...
            <div className="relative min-h-screen min-w-screen bg-[#111111] overflow-hidden">
                ...
                <img
                    src="https://raw.githubusercontent.com/33binil/Randall-s-Spices/main/public/About.jpg"
                    alt="About Me"
            ...
            {/* About Words */}
            <div className="relative top-16 md:top-32 mb-36 px-8 md:px-[200px] text-white">

                <h1 className="relative top-16 text-white font-inknut text-[35px] md:text-[50px] text-center md:top-16 font-black mb-28">
                    Introducing OmniBlend
                </h1>

                <div className="relative flex-col flex md:flex-row gap-x-40">
                    ...
                    <div className="relative mt-[-24px] left-10 md:left-0">
                        <img
                            src="https://raw.githubusercontent.com/33binil/Randall-s-Spices/main/public/Aboutimage.png"
                            alt="About Image"
